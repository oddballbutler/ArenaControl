...
void Timer::countDown()
{
    ...
    {
    case 10:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/10.wav");
        break;
    case 9:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/9.wav");
        break;
    case 8:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/8.wav");

        break;
    case 7:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/7.wav");
        break;
    case 6:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/6.wav");
        break;
    case 5:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/5.wav");
        break;
    case 4:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/4.wav");
        break;
    case 3:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/3.wav");
        break;
    case 2:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/2.wav");
        break;
    case 1:
        QSound::play("/Users/jeremybutler/Workspace/EventControl/1.wav");
        break;
    }
...
void Timer::start()
{
    ...
    currentSeconds = 3;
    QSound::play("/Users/jeremybutler/Workspace/EventControl/beep-6.wav");
    displayTime();
...
void Timer::startCountDown()
{
    ...
    if(currentSeconds == 0)
    {
        QSound::play("/Users/jeremybutler/Workspace/EventControl/beep-7.wav");
